...
App.controller 'GearController', ['$scope', '$q', '$http', '$timeout', '$filter', 'Restangular', 'resolvedGearItems', 'resolvedGearLists', 'resolvedUserStatus', 'GearItems', 'GearLists', 'UserStatus', ($scope, $q, $http, $timeout, $filter, Restangular, resolvedGearItems, resolvedGearLists, resolvedUserStatus, GearItems, GearLists, UserStatus) ->
    ...
    $scope.editGearItem = (gearItem) ->
        ...
        $scope.gearItemBeingEdited.weight = $filter('fromGramsTo')($scope.gearItemBeingEdited.weight, $scope.userStatus.weight_unit, $scope.userStatus.weight_precision)
    ...
    $scope.updateGearItem = (gearItem) ->
        ...
        gearItem.weight = $filter('toGramsFrom')(gearItem.weight, $scope.userStatus.weight_unit, $scope.userStatus.weight_precision)
        gearItem.put().then (data) ->
